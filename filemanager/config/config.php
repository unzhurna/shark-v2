...
$config = array(
	...
	*/
	...
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'].'/shark-v2',
	...
	*/
	...
	'access_keys' => array('SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG'),
