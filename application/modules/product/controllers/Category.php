...
class Category extends MX_Controller{
    ...
    {
        $this->breadcrumbs->push('Product Categories', '/');
    ...
    private function _get_button($id)
    {
        ...
        $button .= '<a class="btn btn-link" title="edit" href="'.site_url('product_category/edit/'.$id).'"><i class="fa fa-edit"></i></a>';
        $button .= '<a class="btn btn-link btn-del" title="delete" href="'.site_url('product_category/delete/'.$id).'"><i class="fa fa-trash"></i></a>';
        $button .= '</div>';
        return $button;
    }
    ...
    public function submit($id=null)
    {
        ...
        $this->breadcrumbs->push('All Categories', '/product_categories');
        ...
        if($this->form_validation->run() == TRUE)
        {
            $save = array(
                ...
                'category_img' => basename($this->input->post('category_img')),
