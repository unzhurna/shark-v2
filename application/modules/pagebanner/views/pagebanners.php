    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><i class="fa fa-pencil"></i>Page Banner</h3>
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('pagebanner/new'); ?>" class="btn btn-info btn-sm">Add New</a>
                </div>
            </div>
            <div class="box-body">
...
$(document).ready(function(){
	...
	oTable = $('#datatable').DataTable({
		...
		"order": [],
		"ajax": {
			"url": "<?php echo site_url('pagebanner/ajax_grid'); ?>",
			"type": "POST"
		},
        "columnDefs": [
