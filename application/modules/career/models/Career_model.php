...
class Career_model extends CI_Model{
    ...
    var $table          = 'careers';
    var $column_order   = array(null, 'career_title', 'date_open', 'date_close', 'is_open', null);
    var $column_search  = array('career_title', 'date_open', 'date_close', 'is_open');
    var $order          = array('career_id' => 'asc');
    ...
    public function get_detail_career($id)
    {
        $this->db->select('*');
